...
function setBackupCookie(name: string, value: string, maxAge: number) {
...
export function LoginForm() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (result.backupCookieName && result.backupCookieValue && result.maxAge) {
        setBackupCookie(result.backupCookieName, result.backupCookieValue, result.maxAge);
      }
